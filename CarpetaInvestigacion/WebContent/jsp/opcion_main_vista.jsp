		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
					<br><br><br><br><br><br>
					<center>
						<a class="btn btn-primary btn-lg sizeButton" href="registrar_main">Registrar</a>
					</center>
					<br><br><br>
					<center>
						<a class="btn btn-default btn-lg sizeButton" href="tramitar_main">Tramitar
							continuada</a>
					</center><br><br><br>
					<center>
						<a class="btn btn-success btn-lg sizeButton" href="reportes">Total
							Reportes</a>
					</center>
