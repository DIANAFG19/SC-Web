...
//Coord. Territorial
    ...
    function carpetaRel() {
		...
		if(document.getElementById("categoriaAveriguacion").value == 2){ //se agrego el if
  ...
  //Colaboracion
	...
	//Tipo tramite
	function categoriaOpciones() {    	
        var value = parseInt( varCT.options[varCT.selectedIndex].value);
        hideCombos();

        switch (value) {        	
            case 1 :
            	document.getElementById("idTurnoFK").selectedIndex = 0;
            	document.getElementById("fecha").required = true;
    			document.getElementById("fecha").disabled = false;
    			document.getElementById("idTurnoFK").disabled = false;
                show(varLibertades);
                show(fecha);
                show(turno);
                break;
            ...
            case 15 :
            	...
            	document.getElementById("idTurnoFK").disabled = true; /*--------------*/
    ...
    //Id Tramite 
	function valorA() {
		var ab = document.getElementById("Libertades").value;
        document.getElementById("idTramiteFK").setAttribute("value", ab);
    }
	function valorB() {
		var bc = document.getElementById("Incompetencias").value;
        document.getElementById("idTramiteFK").setAttribute("value", bc);
    }
	function valorC() {
	    ...
	    document.getElementById("idTramiteFK").setAttribute("value", 0);
		}
	}
	...
	function verificarCamposReg(){
		...
		if(document.getElementById("Libertades").value == 0 && document.getElementById("categoriaTramite").value == 1){
			todo_correcto = false;
			alert("Falta elegir Tr\u00e1mite/Libertades");
		}
		if(document.getElementById("Incompetencias").value == 0 && document.getElementById("categoriaTramite").value == 2){
			todo_correcto = false;
			alert("Falta elegir Tr\u00e1mite/Incompetencias");
		}
		
		//Turno
		if(document.getElementById("idTurnoFK").value == 0 && (document.getElementById("categoriaTramite").value == 1 || document.getElementById("categoriaTramite").value == 2 || document.getElementById("categoriaTramite").value == 16)){
			todo_correcto = false;
			alert("Falta elegir Turno");
		}
    ...
    /*function limpiarImputados() {
		...
		document.getElementById("tieneAntecedentes").value = "";
	}*/
    
    function selectTurno() {
		if(document.getElementById("idTurnoFK").value == 1){
			document.getElementById("turno").value = "T1";
		}
		else if(document.getElementById("idTurnoFK").value == 2){
			document.getElementById("turno").value = "T2";
		}
		else if(document.getElementById("idTurnoFK").value == 3){
			document.getElementById("turno").value = "T3";
		}
		else if(document.getElementById("idTurnoFK").value == 0){
			document.getElementById("turno").value = "";
		}	
	}
